...
{               ?>
 ...
 <li class="nav-item">
      ...
      <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#auth23" aria-expanded="false" aria-controls="auth2">
                <span class="menu-title">Enquiries</span>
                <i class="icon-doc menu-icon"></i>
              </a>
              <div class="collapse" id="auth23">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="manage-enquiries.php">Manage Enquiries</a></li>
                </ul>
              </div>
            </li>
